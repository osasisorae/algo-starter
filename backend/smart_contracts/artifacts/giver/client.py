...
class GiverClient:
    """A class for interacting with the giver app providing high productivity and
    ...
    def __init__(
        ...
        *,
        ...
        """
        GiverClient can be created with an app_id to interact with an existing application, alternatively
