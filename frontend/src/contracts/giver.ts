...
/**
 * Defines the types of available calls and state of the Giver smart contract.
 */
export type Giver = {
  /**
 ...
 */
export type GiverSig = keyof Giver['methods']
/**
 * Defines an object containing all relevant parameters for a single call to the contract. Where TSignature is undefined, a bare call is made
 */
export type TypedCallParams<TSignature extends GiverSig | undefined> = {
  method: TSignature
...
/**
 * Maps a method signature from the Giver smart contract to the method's arguments in either tuple of struct form
 */
export type MethodArgs<TSignature extends GiverSig> = Giver['methods'][TSignature]['argsObj' | 'argsTuple']
/**
 * Maps a method signature from the Giver smart contract to the method's return type
 */
export type MethodReturn<TSignature extends GiverSig> = Giver['methods'][TSignature]['returns']

/**
 * A factory for available 'create' calls
 */
export type GiverCreateCalls = (typeof GiverCallFactory)['create']
/**
 * Defines supported create methods for this smart contract
 */
export type GiverCreateCallParams =
  | (TypedCallParams<undefined> & (OnCompleteNoOp))
/**
 * A factory for available 'update' calls
 */
export type GiverUpdateCalls = (typeof GiverCallFactory)['update']
/**
 * Defines supported update methods for this smart contract
 */
export type GiverUpdateCallParams =
  | TypedCallParams<undefined>
/**
 * A factory for available 'delete' calls
 */
export type GiverDeleteCalls = (typeof GiverCallFactory)['delete']
/**
 * Defines supported delete methods for this smart contract
 */
export type GiverDeleteCallParams =
  | TypedCallParams<undefined>
/**
 * Defines arguments required for the deploy method.
 */
export type GiverDeployArgs = {
  deployTimeParams?: TealTemplateParams
  /**
   * A delegate which takes a create call factory and returns the create call params for this smart contract
   */
  createCall?: (callFactory: GiverCreateCalls) => GiverCreateCallParams
  /**
   * A delegate which takes a update call factory and returns the update call params for this smart contract
   */
  updateCall?: (callFactory: GiverUpdateCalls) => GiverUpdateCallParams
  /**
   * A delegate which takes a delete call factory and returns the delete call params for this smart contract
   */
  deleteCall?: (callFactory: GiverDeleteCalls) => GiverDeleteCallParams
}
 ...
 */
export abstract class GiverCallFactory {
  /**
  ...
  static get create() {
    return {
      /**
       * Constructs a create call for the giver smart contract using a bare call
       *
  ...
  static get update() {
    return {
      /**
       * Constructs an update call for the giver smart contract using a bare call
       *
       * @param params Any parameters for the call
       * @returns A TypedCallParams object for the call
       */
  ...
  static get delete() {
    return {
      /**
       * Constructs a delete call for the giver smart contract using a bare call
       *
       * @param params Any parameters for the call
       * @returns A TypedCallParams object for the call
       */
...
/**
 * A client to make calls to the giver smart contract
 */
export class GiverClient {
  ...
  /**
   * Creates a new instance of `GiverClient`
   *
   ...
   */
  public async call<TSignature extends keyof Giver['methods']>(typedCallParams: TypedCallParams<TSignature>, returnValueFormatter?: (value: any) => MethodReturn<TSignature>) {
    return this.mapReturnValue<MethodReturn<TSignature>>(await this.appClient.call(typedCallParams), returnValueFormatter)
  }

  /**
   * Idempotently deploys the giver smart contract.
   *
   * @param params The arguments for the contract calls and any additional parameters for the call
   * @returns The deployment result
   */
  public deploy(params: GiverDeployArgs & AppClientDeployCoreParams = {}): ReturnType<ApplicationClient['deploy']> {
    const createArgs = params.createCall?.(GiverCallFactory.create)
    const updateArgs = params.updateCall?.(GiverCallFactory.update)
    const deleteArgs = params.deleteCall?.(GiverCallFactory.delete)
  ...
  public get create() {
    ...
    return {
      /**
       * Creates a new instance of the giver smart contract using a bare call.
       *
  ...
  public get update() {
    ...
    return {
      /**
       * Updates an existing instance of the giver smart contract using a bare call.
       *
       * @param args The arguments for the bare call
  ...
  public get delete() {
    ...
    return {
      /**
       * Deletes an existing instance of the giver smart contract using a bare call.
       *
       * @param args The arguments for the bare call
  ...
  /**
   * Makes a clear_state call to an existing instance of the giver smart contract.
   *
   * @param args The arguments for the bare call
  ...
  public hello(args: MethodArgs<'hello(string)string'>, params: AppClientCallCoreParams & CoreAppCallArgs = {}) {
    return this.call(GiverCallFactory.hello(args, params))
  }

  public compose(): GiverComposer {
    const client = this
    ...
    } as unknown as GiverComposer
  }
}
export type GiverComposer<TReturns extends [...any[]] = []> = {
  /**
   * Calls the hello(string)string ABI method.
   *
   * @param args The arguments for the contract call
   ...
   */
  hello(args: MethodArgs<'hello(string)string'>, params?: AppClientCallCoreParams & CoreAppCallArgs): GiverComposer<[...TReturns, MethodReturn<'hello(string)string'>]>
  ...
  readonly update: {
     ...
     * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
     */
    bare(args?: BareCallArgs & AppClientCallCoreParams & AppClientCompilationParams & CoreAppCallArgs): GiverComposer<[...TReturns, undefined]>
  }
  ...
  readonly delete: {
     ...
     * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
     */
    bare(args?: BareCallArgs & AppClientCallCoreParams & CoreAppCallArgs): GiverComposer<[...TReturns, undefined]>
  }
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  clearState(args?: BareCallArgs & AppClientCallCoreParams & CoreAppCallArgs): GiverComposer<[...TReturns, undefined]>
   ...
   */
  addTransaction(txn: TransactionWithSigner | TransactionToSign | Transaction | Promise<SendTransactionResult>, defaultSender?: SendTransactionFrom): GiverComposer<TReturns>
  /**
   ...
   */
  execute(): Promise<GiverComposerResults<TReturns>>
}
export type GiverComposerResults<TReturns extends [...any[]]> = {
  returns: TReturns
  groupId: string
  txIds: string[]
